...
class DashboardServiceTest {
    ...
    class StatusEnumTest {
        ...
        void status_containsOnlyValidDbValues() {
            ...
            assertThat(names).containsExactlyInAnyOrder("PENDING", "PROCESSING", "DENIED", "FULFILLED", "MIGRATING", "EXPIRING", "DELETED");
        ...
        void statusFilter_containsAll() {
            ...
            assertThat(names).containsExactlyInAnyOrder("PENDING", "PROCESSING", "DENIED", "FULFILLED", "MIGRATING", "EXPIRING", "DELETED", "ALL");
        }
    }
}
